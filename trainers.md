...
![Jennifer Cervella]({{ site.url }}/public/Jenn.jpg){:style="float: left;margin-left: 7px;margin-top: 7px;"}
...
![Bridgit Donnely]({{ site.url }}/public/Bridgit.jpg){:style="float: left;margin-left: 7px;margin-top: 7px;"}
...
![Katie Ellis]({{ site.url }}/public/Katie.jpg){:style="float: left;margin-left: 7px;margin-top: 7px;"}
...
![Cristina Sinclaire]({{ site.url }}/public/Cristina.png){:style="float: left;margin-left: 7px;margin-top: 7px;"}
...
![Lena Tom]({{ site.url }}/public/Lena.png){:style="float: left;margin-left: 7px;margin-top: 7px;"}
